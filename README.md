...
Please read the book [PowerShell for OpenAI](https://aips.book.xizhang.com) for more information.

## Prerequisites

You must have PowerShell to use this module, it is included in Windows by default, if you use MacOS or Linux, you can install it by following the guidance.
